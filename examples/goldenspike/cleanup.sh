...
if [[ -z "${RAILDIR}" ]] then;
   ...
   \rm -rf examples/goldenspike/goldenspike.yml
   \rm -rf examples/goldenspike/goldenspike_config.yml
else
   ...
   \rm -rf ${RAILDIR}/examples/goldenspike/goldenspike.yml
   \rm -rf ${RAILDIR}/examples/goldenspike/goldenspike_config.yml     
fi
