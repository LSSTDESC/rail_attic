...
def save_to_npy(filenames, properties):
    ...
    for i in range(len(filenames)): np.save(filenames[i], properties[i])
...
def create_testdata_DSPSSingleSedModeler(default_files_folder):
    ...
    testdata_filenames = {'age_grid': os.path.join(default_files_folder, 'age_grid.npy'),
    ...
    save_to_npy(list(testdata_filenames.values()), [log_age_gyr, lgZsun_bin_mids, sfh_table, t_table, logsm_table])
...
def create_test_data_DSPSPopulationSedModeler(default_files_folder):
    ...
    testdata_filenames = {'age_grid': os.path.join(default_files_folder, 'age_grid.npy'),
                          ...
                          'population_metallicities': os.path.join(default_files_folder,
                                                                   'galaxy_population_metallicities.npy'),
                          'population_metallicity_scatters': os.path.join(default_files_folder,
                                                                          'galaxy_population_metallicity_scatters.npy'),
                          'wrong_ages': os.path.join(default_files_folder, 'galaxy_population_wrong_ages.npy'),
                          'wrong_metallicities': os.path.join(default_files_folder,
                                                              'galaxy_population_wrong_metallicities.npy')}
    ...
    save_to_npy(list(testdata_filenames.values()), [log_age_gyr, lgZsun_bin_mids, sfhs_table, ts_table, logsms_table,
                                                    galaxy_ages, galaxy_metallicities, galaxy_metallicity_scatters,
                                                    wrong_ages, wrong_metallicities])
